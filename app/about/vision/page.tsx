            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-[13px] text-slate-300">
                  Material traceability from hide to carton. Buyers can verify
                  origin, tannery, and processing stages.
                </p>
              </div>
            </div>
          </article>
          ...
          <article className="rounded-2xl border border-slate-800 bg-slate-900/50 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-[13px] text-slate-300">
                  Numeric tolerances, recorded test reports and per-batch sample
                  images you can inspect remotely.
                </p>
              </div>
            </div>
          </article>
          ...
          <article className="rounded-2xl border border-slate-800 bg-slate-900/50 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-[13px] text-slate-300">
                  We design processes so lead-times are forecastable, with
                  documented cadence instead of vague promises.
                </p>
              </div>
            </div>
          </article>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
            <div className="text-center">
              ...
              <div className="mt-1 text-sm text-slate-300">
                On-time shipments (last 12 months)
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="mt-1 text-sm text-slate-300">
                Reported defects (per million pcs)
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-12">
        ...
        <ol className="relative ml-4 border-l border-slate-800 pl-6">
          <li className="mb-8">
            ...
            <div className="mt-1 text-sm text-slate-300">
              Implement QR-tagging on 3 SKUs and share tracking access with
              anchor buyers.
            </div>
          </li>
          ...
          <li className="mb-8">
            ...
            <div className="mt-1 text-sm text-slate-300">
              Batch-level photo records, automated tolerance checks and digital
              sign-offs.
            </div>
          </li>
          ...
          <li>
            ...
            <div className="mt-1 text-sm text-slate-300">
              Formalised pre-shipment audits for consistent FCL/LCL shipments.
            </div>
          </li>
        </ol>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-6 text-center">
          ...
          <p className="mt-2 text-sm text-slate-300">
            Request our verification pack: QC reports, sample photos, and
            lead-time SLAs.
          </p>
          <div className="mt-4 flex justify-center gap-3">
            <Link
              href="/contact"
              className="inline-block rounded bg-sky-300 px-5 py-2 text-sm font-semibold text-slate-900 hover:bg-sky-200"
            >
              Request verification pack
            </Link>
            <Link
              href="/products"
              className="inline-block rounded border border-slate-700 px-5 py-2 text-sm text-slate-200 hover:border-sky-300"
            >
              Browse products
            </Link>
          </div>
